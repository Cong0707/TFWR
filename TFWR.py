...
# -------------------------------------------------------------------------------
def simulate(filename: str, sim_unlocks: dict[Unlocks, float] | Iterable[Unlocks] | type[Unlocks],
             sim_items: dict[Item, float], sim_globals: dict[str, Any], seed: float, speedup: float) -> None:
    """
